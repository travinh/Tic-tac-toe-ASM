...
;Program Description:  I finished the game tic-tac-toe 3x3, and I passed all the requirements and I also have 2 files of PDF
...
.data							   ; the data segment
	...
	promptWelcome	BYTE "                   Welcome to tic-tac-toe game(3x3)",0h
	promptStar		BYTE "*************************************************************************",0h
	promptWelcome1	BYTE "If you can get 3 on a row (by column, row or cross), then you win.",0h
...
; require:  nothing
	...
	;-------------------------Display Column Win----------------
DisplayColWin:
	sub		esi,6					; mov esi to the first square
	mov		ebx,esi		
...
PrintColor:
	...
	;----------------------Display Row Win ---------------------------
DisplayRowWin:
		sub		esi,2				; esi keep the first square of row win
		mov		cl, LengthOfArr6
	LoopDisplay4:
		mov		eax,edi
		sub		eax,esi
